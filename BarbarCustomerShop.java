...
/*Baber customer working using blocking queue*/
...
class Customer implements Runnable {
    ...
    /*Customers to come in when seats are available and notify the barber to start working*/
    @Override
    public void run() {
        try {
...
class Barbar implements Runnable{
    ...
    /*Barber works on the customers,as customers have occupied seats*/
    @Override
    public void run() {
        while(true){
            try {
